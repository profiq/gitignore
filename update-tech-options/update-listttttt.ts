...
const techOptionsDict: { [key: string]: string } = techOptions;
/**
...
export function genTechOptionsDict() {
  ...
  let techOptionsDictSorted: { [key: string]: string } = {};
 ...
 */
export function getFilesForLink(files: Dirent[], option: string): string[] {
  return files
    .filter((file) => {
...
export function getLinksDict() {
  let linksDict: { [key: string]: string[] } = {};
  ...
  let linksDictSorted: { [key: string]: string[] } = {};
